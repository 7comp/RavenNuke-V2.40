...
if ($ya_config['requireadmin'] == 0 AND $ya_config['useactivate'] == 0) {
	...
	if ($ya_config['useinstantmessaim'] >= '1') echo '<p><label for="user_aim">' . _YAIM . ':</label><input type="text" name="user_aim" size="30" maxlength="100" /></p>';
	if ($ya_config['useinstantmessicq'] >= '1') echo '<p><label for="user_icq">' . _YICQ . ':</label><input type="text" name="user_icq" size="30" maxlength="100" /></p>';
	if ($ya_config['useinstantmessmsn'] >= '1') echo '<p><label for="user_msnm">' . _YMSNM . ':</label><input type="text" name="user_msnm" size="30" maxlength="100" /></p>';
	if ($ya_config['useinstantmessyim'] >= '1') echo '<p><label for="user_yim">' . _YYIM . ':</label><input type="text" name="user_yim" size="30" maxlength="100" /></p>';
