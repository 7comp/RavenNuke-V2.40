...
if (($radminsuper==1) OR ($radminuser==1)) {
	...
	if ($db->sql_numrows($db->sql_query($sql)) > 0) {
		...
		if ($ya_config['useinstantmessaim'] >= '1') echo '<tr><td>'._AIM.':</td><td><b>'.$chnginfo['user_aim'].'&nbsp;</b></td></tr>';
		if ($ya_config['useinstantmessicq'] >= '1') echo '<tr><td>'._ICQ.':</td><td><b>'.$chnginfo['user_icq'].'&nbsp;</b></td></tr>';
		if ($ya_config['useinstantmessmsn'] >= '1') echo '<tr><td>'._MSNM.':</td><td><b>'.$chnginfo['user_msnm'].'&nbsp;</b></td></tr>';
		if ($ya_config['useinstantmessyim'] >= '1') echo '<tr><td>'._YIM.':</td><td><b>'.$chnginfo['user_yim'].'&nbsp;</b></td></tr>';
