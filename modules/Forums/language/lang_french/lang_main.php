...
$lang['Record_online_users'] = 'Le nombre maximum d’utilisateurs en ligne simultanément a été de <b>%s</b> le %s'; // first %s = number of users, second %s is the date.
...
$lang['HTML_is_ON'] = 'L’HTML est <u>activé</u>';
$lang['HTML_is_OFF'] = 'L’HTML est <u>désactivé</u>';
