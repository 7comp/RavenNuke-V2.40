...
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_POST_A}</span></td>
</tr>
...
<!-- END switch_privmsg -->
<tr>
<td class="row1" width="15%"><strong>{L_SUBJECT}</strong></td>
<td class="row2" width="85%"> <input type="text" name="subject" size="45" maxlength="60" style="width:650px" tabindex="2" class="post" value="{SUBJECT}" />
</td>
</tr>
<tr>
...
<tr>
<td colspan="9">
<textarea name="message" rows="15" cols="35" style="width:650px" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
</td>
</tr>
</table>
</td>
