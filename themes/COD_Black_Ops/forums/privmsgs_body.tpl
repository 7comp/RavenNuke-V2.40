...
<tr>
<td class="cat" align="center"><span class="forumstitle">{L_FLAG}</span></td>
<td class="cat" align="center" width="55%"><span class="forumstitle">{L_SUBJECT}</span></td>
<td class="cat" align="center" width="20%"><span class="forumstitle">{L_FROM_OR_TO}</span></td>
<td class="cat" align="center" width="15%"><span class="forumstitle">{L_DATE}</span></td>
<td class="cat" align="center" width="5%"><span class="forumstitle">{L_MARK}</span></td>
</tr>
<!-- BEGIN listrow -->
<tr>
...
<td class="{listrow.ROW_CLASS}">&nbsp;<a href="{listrow.U_READ}" class="name">{listrow.SUBJECT}</a></td>
