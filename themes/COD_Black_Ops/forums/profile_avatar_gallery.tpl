...
<tr>
<td class="cat" align="center" colspan="{S_COLSPAN}"><span class="forumstitle">{L_AVATAR_GALLERY}</span></td>
</tr>
<tr>
<td class="row1" align="center" colspan="6"><table width="0%" border="0" cellspacing="0" cellpadding="0">
<tr>
