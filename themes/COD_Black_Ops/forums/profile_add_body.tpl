...
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_REGISTRATION_INFO}</span></td>
</tr>
<tr>
...
<input type="password" class="post" style="width: 200px" name="password_confirm" size="25" maxlength="100" value="{PASSWORD_CONFIRM}" />
   ...
   <!-- END switch_confirm -->
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_PROFILE_INFO}</span></td>
</tr>
<tr>
...
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_PREFERENCES}</span></td>
</tr>
<tr>
...
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_AVATAR_PANEL}</span></td>
</tr>
<tr>
