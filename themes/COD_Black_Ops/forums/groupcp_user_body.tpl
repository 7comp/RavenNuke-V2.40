...
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_GROUP_MEMBERSHIP_DETAILS}</span></td>
</tr>
...
<tr>
<td class="cat" align="center" colspan="2"><span class="forumstitle">{L_JOIN_A_GROUP}</span></td>
</tr>
<tr>
