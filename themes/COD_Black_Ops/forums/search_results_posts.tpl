...
<tr>
<td class="cat" align="center" width="150px"><span class="forumstitle">{L_AUTHOR}</span></td>
<td class="cat" align="center" width="100%"><span class="forumstitle">{L_MESSAGE}</span></td>
</tr>
<!-- BEGIN searchresults -->
<tr>
