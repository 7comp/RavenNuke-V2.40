...
$urlin = array(
'"(?<!/)modules.php\?name=Journal&amp;file=search&amp;bywhat=aid&amp;exact=1&amp;forwhat=([a-zA-Z0-9_-]*)"',
'"(?<!/)modules.php\?name=Journal&amp;file=(search|delete|commentkill)&amp;(bywhat|jid|onwhat)=([a-zA-Z0-9]*)&amp;(forwhat|ref)=([a-zA-Z0-9_-]*)"',
