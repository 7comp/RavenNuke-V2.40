...
$version_number = "2.40.01";
$filedate = 'March 10, 2010';
...
<div class="install">
					...
					<div class="form-block">
						<span class="install-note">The Ravenstaller&trade; requires JavaScript to be enabled and a browser that is capable of Document Object Model (DOM) access.  FireFox v3.x is strongly recommended and is what the installer was built upon.  Any other browser that is W3C compliant should work without issue.  Internet Explorer v6 and higher should work but is not guaranteed as Microsoft is the least standards compliant.  If any of these items are highlighted in red then you should not use this version of the installer.  Future versions may allow for more exceptions but for now this is it.</span>
<br />
					  <fieldset>
						 ...
						 <legend class="toggle">Platform Information</legend>
							<table class="content2">
								<tr>
									...
									<td align="left">
										<?php echo phpversion() < '4.3' ? '<span class="redbold">No : Version '.phpversion().'</span>' : '<span class="greenbold">Yes : Version '.phpversion().'</span>';?>
									</td>
								</tr>
								<tr>
									<td>
