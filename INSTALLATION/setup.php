...
<div class="c1">
	 ...
	 <span class="c5">
		RavenNuke&trade; v<?php echo RAVENNUKE_VERSION_FRIENDLY;?> Setup/Configuration Tool &copy;2005-2010
	 </span>
</div>
<br /><br /><br />
<div align="center">
...
function rnInstallErr($errNum) {
	 ...
	 elseif ($errNum==2) die('<span class="c2">I was unable to reach your MySQL server using the MySQL connection settings in your nuke config.php file.  The exact error message that your MySQL server reported is <b>'.mysql_error().'</b>.</span>');
	 elseif ($errNum==3) die('<span class="c2">I was able to reach your MySQL server using the MySQL connection settings in your nuke config.php file, but I was unable to reach/locate the database <b>'.$dbname.'</b>. The exact error message that your MySQL server reported is <b>'.mysql_error().'</b>.</span>');
	 elseif ($errNum==4) die('<span class="c2">ERROR!  The exact error message that your MySQL server reported is <b>'.mysql_error().'</b>.</span>');
...
<hr />
	 ...
	 <div align="center" class="msg">
		Copyright 2005-2010 &copy;Raven Web Services<span class="c1"><sup>&trade;</sup></span>, LLC -- All Rights reserved --<br />
	...
	// if (!$rc) die('Unable to update '.$prefix.'_nsngr_users table. MySQL reported: '.mysql_error()."<br />$sql");
	 ...
	 if ($rc) {
		  ...
		  if ($content != '') {
				...
				$content = eregi_replace('($config_nukeurl/images/)', $config_nukeurl.'/images/', $content);
