...
/*  Rudimentary - for diagnosing problems */
...
if (file_exists(INCLUDE_PATH . 'includes/mimetype.php')) require_once INCLUDE_PATH . 'includes/mimetype.php';
else {
	echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" '."\n".'"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">'
	."\n".'<html xmlns="http://www.w3.org/1999/xhtml">'
	;
...
<br /><br /><br />
<div>
<div align="center"><p id="warning"><?php echo "This Installer will <u>REFRESH</u> the NukeSentinel&trade; nsnst.ip2country &amp; nsnst.countries tables by <u>REPLACING</u> them - This is <u>NOT</u> recoverable.";?></p></div>
	 <hr />
	 ...
	 <table>
	  <tr>
		...
		<table><tr><td>
			...
			<hr />
			<p class="ip2cnote"><?php echo _rnSTEP3;?>&nbsp;:&nbsp;&nbsp;<?php echo _rnLOAD_IP2COUNTRY_DATA;?>
...
<?php if ($_GET['setup']) {echo '<div class="c1"><p id="proceed">'.'Your NukeSentinel&trade; IP2COUNTRY and COUNTRIES tables should now be updated.'.'</p></div>'; session_destroy(); $_GET['setup']='';} ?>
	 <hr />
...
$isValidOp = FALSE;
$validOp = array('lsec','lns','lip1','lip2','lip3','lip4','lip5','lip6','lip7','lip8','lip9','lip10');
...
if (strlen($_POST[_rnSUBMIT])>0 AND $isValidOp AND $_POST['op']!=='lsec') {
	 if ($_POST['op']=='lns') {
			...
			$rc = @mysql_query($sql);
		  $rnSql = array('rnNukeSentinelSql'=>'ns_countries.sql');
	 }
