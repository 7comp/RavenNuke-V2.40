...
define('_rnWARNING','Este archivo es para <u>NUEVAS</u> instalaciones y <u>REEMPLAZAR&Aacute;</u> tus tablas y datos cada vez que sea ejecutado. Esto <u>NO</u> es recuperable.');
...
define('_rnSUCCESS_CONNECT_HOST','<b>Conectado correctamente a <span class="c3">'.$dbhost.'</span> con el usuario <span class="c3">'.$dbuname.'</span> y la contrase&ntilde;a asignada!</b><br />');
define('_rnFOUND_DB','<b>Se encontr&oacute; la base de datos <span class="c3">'.$dbname.'</span>!</b><br />');
define('_rnTABLE_PREFIX','<b>Las tablas ser&aacute;n instaladas con el prefijo <span class="c3">'.$prefix.'</span>. <br />Las tablas de usuarios ser&aacute;n instaladas con el prefijo <span class="c3">'.$user_prefix.'</span>.<br />Si esto no es correcto, edite el archivo config.php y haga los ajustes de lugar para <span class="c2">$prefix</span> y <span class="c2">$user_prefix</span>.</b><br />');
...
define('_rnERR3','<span class="c2">Fue posible conectar al servidor MySQL usando las opciones de conexi&oacute;n MySQL en el archivo config.php, pero no fue posible conectar a la base de datos <b>'.$dbname.'</b>. El error exacto que el servidor MySQL report&oacute; fue:</span>');
...
define('_rnLOAD_IP2COUNTRY_DATA1_10' ,'Cargar Datos de IP2COUNTRY Parte 1/10');
define('_rnLOAD_IP2COUNTRY_DATA2_10' ,'Cargar Datos de IP2COUNTRY Parte 2/10');
define('_rnLOAD_IP2COUNTRY_DATA3_10' ,'Cargar Datos de IP2COUNTRY Parte 3/10');
define('_rnLOAD_IP2COUNTRY_DATA4_10' ,'Cargar Datos de IP2COUNTRY Parte 4/10');
define('_rnLOAD_IP2COUNTRY_DATA5_10' ,'Cargar Datos de IP2COUNTRY Parte 5/10');
define('_rnLOAD_IP2COUNTRY_DATA6_10' ,'Cargar Datos de IP2COUNTRY Parte 6/10');
define('_rnLOAD_IP2COUNTRY_DATA7_10' ,'Cargar Datos de IP2COUNTRY Parte 7/10');
define('_rnLOAD_IP2COUNTRY_DATA8_10' ,'Cargar Datos de IP2COUNTRY Parte 8/10');
...
define('_rnIP2COUNTRY_NOTE','La tabla IP2Country de NukeSentinel&trade; es muy grande, por tanto fue dividida en los PASOS 3a-3j.');
