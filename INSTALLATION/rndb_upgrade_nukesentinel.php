...
else {  // config value sent as null
	init($config_value);
}
function init($config_value) {
	...
	if ($config_value == NUKESENTINEL_VERSION) {
		echo '<span class="c1">Congratulations.  It appears that your NukeSentinel&trade; configuration value has been updated to '.NUKESENTINEL_VERSION.'.  You can continue with your installation process following the instructions in the How to Install Documentation.<br /><br /></span>';
	}
...
// update of version number moved from here feb. 2009 .. now below in all inclusive area
	...
	echo "$message<hr>\n";
	echo "<span class=\"c3\"><u>Do not forget to delete this upgrade file from your server when you are finished upgrading.</u></span></td></tr></table></div><br /><br />";
	echo '<a href="http://rnwiki.ravennuke.com/wiki/RavenNuke2:Installation">Return to Documentation</a><br /><br />';
}
?>