...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_admins` (`aid` varchar(25) NOT NULL default '', `login` varchar(25) NOT NULL default '', `password` varchar(40) NOT NULL default '', `password_md5` varchar(60) NOT NULL default '', `password_crypt` varchar(60) NOT NULL default '', `protected` tinyint(2) NOT NULL default '0', PRIMARY KEY  (`aid`)) TYPE=MyISAM;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_cidrs` ( `cidr` int(2) NOT NULL default '0', `hosts` int(10) NOT NULL default '0', `mask` varchar(15) NOT NULL default '', PRIMARY KEY  (`cidr`)) TYPE=MyISAM;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_config` ( `config_name` varchar(255) NOT NULL default '', `config_value` longtext NOT NULL, PRIMARY KEY  (`config_name`)) TYPE=MyISAM;
...
INSERT INTO $prefix.`_nsnst_config` (`config_name`, `config_value`) VALUES('santy_protection', '1');
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_countries` ( `c2c` char(2) NOT NULL default '', `country` varchar(60) NOT NULL default '', PRIMARY KEY  (`c2c`)) TYPE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_nsnst_excluded_ranges`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_excluded_ranges` ( `ip_lo` int(10) unsigned NOT NULL default '0', `ip_hi` int(10) unsigned NOT NULL default '0', `date` int(20) NOT NULL default '0', `notes` text NOT NULL, `c2c` char(2) NOT NULL default '00', PRIMARY KEY  (`ip_lo`,`ip_hi`), KEY `c2c` (`c2c`), KEY `date` (`date`)) TYPE=MyISAM;
INSERT INTO $prefix.`_nsnst_excluded_ranges` (`ip_lo`, `ip_hi`, `date`, `notes`, `c2c`) VALUES(2130706433, 2130706433, 1217476773, 'Admin''s personal ip', '00');

DROP TABLE IF EXISTS $prefix.`_nsnst_harvesters`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_harvesters` ( `hid` int(2) NOT NULL auto_increment, `harvester` varchar(255) NOT NULL default '', PRIMARY KEY  (`harvester`), KEY `hid` (`hid`)) TYPE=MyISAM;
...
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_ip2country` ( `ip_lo` int(10) unsigned NOT NULL default '0', `ip_hi` int(10) unsigned NOT NULL default '0', `date` int(20) NOT NULL default '0', `c2c` char(2) NOT NULL default '', PRIMARY KEY  (`ip_lo`,`ip_hi`,`c2c`), UNIQUE KEY `c2c` (`c2c`,`ip_hi`,`ip_lo`)) TYPE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_nsnst_protected_ranges`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_protected_ranges` ( `ip_lo` int(10) unsigned NOT NULL default '0', `ip_hi` int(10) unsigned NOT NULL default '0', `date` int(20) NOT NULL default '0', `notes` text NOT NULL, `c2c` char(2) NOT NULL default '00', PRIMARY KEY  (`ip_lo`,`ip_hi`), KEY `c2c` (`c2c`), KEY `date` (`date`)) TYPE=MyISAM;
INSERT INTO $prefix.`_nsnst_protected_ranges` (`ip_lo`, `ip_hi`, `date`, `notes`, `c2c`) VALUES(2130706433, 2130706433, 1217476773, 'Admin''s personal ip', '00');

DROP TABLE IF EXISTS $prefix.`_nsnst_referers`;
CREATE TABLE IF NOT EXISTS $prefix.`_nsnst_referers` ( `rid` int(2) NOT NULL auto_increment, `referer` varchar(255) NOT NULL default '', PRIMARY KEY  (`referer`), KEY `rid` (`rid`)) TYPE=MyISAM;
