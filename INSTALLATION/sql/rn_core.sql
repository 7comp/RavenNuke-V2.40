...
INSERT INTO $prefix.`_blocks` VALUES (NULL, '', 'Big Story of Today', '', '', 'r', 5, 1, 3600, '', '', 'block-Big_Story_of_Today.php', 0, '0', 'd', 0,0);
INSERT INTO $prefix.`_blocks` VALUES (NULL, '', 'Old Articles', '', '', 'r', 6, 1, 3600, '', '', 'block-Old_Articles.php', 0, '0', 'd', 0,0);
INSERT INTO $prefix.`_blocks` VALUES (NULL, '', 'Information', '<br /><center><span class="content">\r\n<a href="http://www.ravenphpscripts.com"><img src="images/powered/RavenWebServices.gif" border="0" alt="Powered by RavenNuke(tm)" title="Powered by RavenNuke(tm)" width="88" height="31" /></a></span></center><br />', '', 'r', 7, 0, 0, '', '', '', 0, '0', 'd', 0,0);
...
INSERT INTO $prefix.`_config` VALUES ('RaveNuke(tm) Powered Site', 'http://mysite.com', 'logo.gif', 'Your slogan here', '2010', 'webmaster@mysite.com', 0, 'fisubice', '', 'All logos and trademarks in this site are property of their respective owner. The comments are property of their posters, all the rest &copy; 2010 by me.', 'You can syndicate our news using the file <a href="backend.php" target="_blank"><font class="footmsg_l">backend.php</font></a>.<br /><br /><font class="footmsg_l"><a href="http://www.ravenphpscripts.com" title="Distributed by Raven PHP Scripts" target="_blank">Distributed by Raven PHP Scripts</a><br />New code written and maintained by the<a href="http://rnwiki.ravennuke.com/wiki/RavenNuke2:Credits" target="_blank"> RavenNuke&trade; TEAM</a></font>', 4096, 'Anonymous', 8, 1, 1, 1, 1, 10, 10, 1, 30, 1, 'RavenNuke(tm) Powered Site', 'en-us', 'english', 'en_US', 0, 0, 0, 'me@mysite.com', 'NEWS for my site', 'Hey! You got a new submission for your site.', 'webmaster', 0, 1, 3, '*****', '<font class="footmsg_l">(Original PHP-Nuke Code Copyright &copy; 2004 by Francisco Burzi)</font>', 'rn2.40.01');
...
CREATE TABLE IF NOT EXISTS $prefix.`_downloads_categories` ( `cid` int(11) NOT NULL auto_increment, `title` varchar(50) NOT NULL default '', `cdescription` text NOT NULL, `parentid` int(11) NOT NULL default '0', PRIMARY KEY  (`cid`), KEY `title` (`title`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_downloads_downloads`;
CREATE TABLE IF NOT EXISTS $prefix.`_downloads_downloads` ( `lid` int(11) NOT NULL auto_increment, `cid` int(11) NOT NULL default '0', `sid` int(11) NOT NULL default '0', `title` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `description` text NOT NULL, `date` datetime default NULL, `name` varchar(100) NOT NULL default '', `email` varchar(100) NOT NULL default '', `hits` int(11) NOT NULL default '0', `submitter` varchar(60) NOT NULL default '', `downloadratingsummary` double(6,4) NOT NULL default '0.0000', `totalvotes` int(11) NOT NULL default '0', `totalcomments` int(11) NOT NULL default '0', `filesize` int(11) NOT NULL default '0', `version` varchar(10) NOT NULL default '', `homepage` varchar(200) NOT NULL default '', PRIMARY KEY  (`lid`), KEY `cid` (`cid`), KEY `sid` (`sid`), KEY `title` (`title`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_downloads_editorials`;
CREATE TABLE IF NOT EXISTS $prefix.`_downloads_editorials` ( `downloadid` int(11) NOT NULL default '0', `adminid` varchar(60) NOT NULL default '', `editorialtimestamp` datetime NOT NULL default '0000-00-00 00:00:00', `editorialtext` text NOT NULL, `editorialtitle` varchar(100) NOT NULL default '', PRIMARY KEY  (`downloadid`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_downloads_modrequest`;
CREATE TABLE IF NOT EXISTS $prefix.`_downloads_modrequest` ( `requestid` int(11) NOT NULL auto_increment, `lid` int(11) NOT NULL default '0', `cid` int(11) NOT NULL default '0', `sid` int(11) NOT NULL default '0', `title` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `description` text NOT NULL, `modifysubmitter` varchar(60) NOT NULL default '', `brokendownload` int(3) NOT NULL default '0', `name` varchar(100) NOT NULL default '', `email` varchar(100) NOT NULL default '', `filesize` int(11) NOT NULL default '0', `version` varchar(10) NOT NULL default '', `homepage` varchar(200) NOT NULL default '', PRIMARY KEY  (`requestid`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_downloads_newdownload`;
CREATE TABLE IF NOT EXISTS $prefix.`_downloads_newdownload` ( `lid` int(11) NOT NULL auto_increment, `cid` int(11) NOT NULL default '0', `sid` int(11) NOT NULL default '0', `title` varchar(100) NOT NULL default '', `url` varchar(100) NOT NULL default '', `description` text NOT NULL, `name` varchar(100) NOT NULL default '', `email` varchar(100) NOT NULL default '', `submitter` varchar(60) NOT NULL default '', `filesize` int(11) NOT NULL default '0', `version` varchar(10) NOT NULL default '', `homepage` varchar(200) NOT NULL default '', PRIMARY KEY  (`lid`), KEY `cid` (`cid`), KEY `sid` (`sid`), KEY `title` (`title`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_downloads_votedata`;
CREATE TABLE IF NOT EXISTS $prefix.`_downloads_votedata` ( `ratingdbid` int(11) NOT NULL auto_increment, `ratinglid` int(11) NOT NULL default '0', `ratinguser` varchar(60) NOT NULL default '', `rating` int(11) NOT NULL default '0', `ratinghostname` varchar(60) NOT NULL default '', `ratingcomments` text NOT NULL, `ratingtimestamp` datetime NOT NULL default '0000-00-00 00:00:00', PRIMARY KEY  (`ratingdbid`) ) ENGINE=MyISAM;
...
CREATE TABLE IF NOT EXISTS $prefix.`_journal` ( `jid` int(11) NOT NULL auto_increment, `aid` varchar(30) NOT NULL default '', `title` varchar(80) default NULL, `bodytext` text NOT NULL, `mood` varchar(48) NOT NULL default '', `pdate` varchar(48) NOT NULL default '', `ptime` varchar(48) NOT NULL default '', `status` varchar(48) NOT NULL default '', `mtime` varchar(48) NOT NULL default '', `mdate` varchar(48) NOT NULL default '', PRIMARY KEY  (`jid`), KEY `aid` (`aid`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_journal_comments`;
CREATE TABLE IF NOT EXISTS $prefix.`_journal_comments` ( `cid` int(11) NOT NULL auto_increment, `rid` varchar(48) NOT NULL default '', `aid` varchar(30) NOT NULL default '', `comment` text NOT NULL, `pdate` varchar(48) NOT NULL default '', `ptime` varchar(48) NOT NULL default '', PRIMARY KEY  (`cid`), KEY `rid` (`rid`), KEY `aid` (`aid`) ) ENGINE=MyISAM;

DROP TABLE IF EXISTS $prefix.`_journal_stats`;
CREATE TABLE IF NOT EXISTS $prefix.`_journal_stats` ( `id` int(11) NOT NULL auto_increment, `joid` varchar(48) NOT NULL default '', `nop` varchar(48) NOT NULL default '', `ldp` varchar(24) NOT NULL default '', `ltp` varchar(24) NOT NULL default '', `micro` varchar(128) NOT NULL default '', PRIMARY KEY  (`id`) ) ENGINE=MyISAM;
...
INSERT INTO $prefix.`_message` VALUES (1, 'Welcome to RavenNuke&trade;!', '<center><a href="http://www.ravenphpscripts.com" title="RavenPHPScripts - Home of RavenNuke(tm)"><img src="http://www.ravennuke.com/images/ravennuke76/RN_Book_NoVersion.png" border="0" alt="" /></a></center><br />Congratulations! You have installed one of the most secure CMS installations available. The RavenNuke&trade; distribution comes with the most up to date patches and the most up to date release of NukeSentinel&trade;. In addition, NukeSentinel&trade; is fully installed and configured! <br /><br /><div align="center"><span style="font-size:10pt;font-weight:bold;color:blue">Language Translations/Translators needed for RavenNuke&trade;<br /><br />February 2010— <a href="http://rnwiki.ravennuke.com/wiki/RavenNuke2:Credits" target="_blank"><u>RavenNuke&trade; Development Team</u></a><br /><br />Hi Folks,<br /><br />We need people that can help to translate the language files into other languages.<br /><br />We have English, German, and Spanish pretty well covered.  Dutch is partially translated but is in progress and soon should be fully translated.  French is only partly translated and we really need volunteers to complete French.<br /><br />If you are able to help then please let us know by posting in the forums at <a href="http://www.ravenphpscripts.com" target="_blank"><u>http://www.ravenphpscripts.com</u></a><br /><br />or sending a private message to any of the staff members.<br /><br />Thanks in advance for your support of RavenNuke&trade;!!</span></div>', '1252991938', 0, 1, 1, '');
...
INSERT INTO $prefix.`_modules` VALUES (NULL, 'Journal', 'Journal', 1, 0, 1, 0, '');
...
INSERT INTO $prefix.`_topics` VALUES (1, 'ravennuke', 'ravennuke76s2.png', 'RavenNuke(tm)', 0);
...
CREATE TABLE IF NOT EXISTS $user_prefix.`_users_temp` ( `user_id` int(10) NOT NULL auto_increment, `username` varchar(25) NOT NULL default '', `user_email` varchar(255) NOT NULL default '', `user_password` varchar(40) NOT NULL default '', `user_regdate` varchar(20) NOT NULL default '', `check_num` varchar(50) NOT NULL default '', `time` varchar(14) NOT NULL default '', PRIMARY KEY  (`user_id`) ) ENGINE=MyISAM;
ALTER TABLE $user_prefix.`_users_temp` ADD `requestor` VARCHAR( 25 ) NOT NULL;
ALTER TABLE $user_prefix.`_users_temp` ADD `name` VARCHAR(255) NOT NULL AFTER username;
...
INSERT INTO $prefix.`_hnl_cfg` VALUES ('dl_module', 'downloads');
...
INSERT INTO $prefix.`_hnl_cfg` VALUES ('version', '01.03.02');
...
CREATE TABLE IF NOT EXISTS $prefix.`_mail_config` ( `active` tinyint(1) NOT NULL default '0', `mailer` tinyint(1) NOT NULL default '1', `smtp_host` varchar(255) NOT NULL default '',  `smtp_helo` varchar(255) NOT NULL default '', `smtp_port` int(10) NOT NULL default '25', `smtp_auth` tinyint(1) NOT NULL default '0', `smtp_uname` varchar(255) NOT NULL default '',  `smtp_passw` varchar(255) NOT NULL default '', `sendmail_path` varchar(255) NOT NULL default '/usr/sbin/sendmail', `qmail_path` varchar(255) NOT NULL default '/var/qmail/bin/sendmail',  PRIMARY KEY  (`mailer`)) ENGINE=MyISAM;
INSERT INTO $prefix.`_mail_config` VALUES(0, 1, 'smtp.tusitio.com', 'smtp.tusitio.com', 25, 0, 'tu@tusitio.com', 'tupassword', '/usr/sbin/sendmail', '/var/qmail/bin/sendmail');
...
INSERT INTO $prefix.`_seo_dh` VALUES (14, 0, '', 0, 25, '', 1, 'RavenNuke(tm) Copyright (c) 2002-2010 by Gaylen Fraley. This is free software, and you may redistribute it under the GPL (http://www.gnu.org/licenses/gpl-2.0.txt). RavenNuke(tm) is supported by the RavenNuke(tm) Team at http://www.ravenphpscripts.com .');
...
INSERT INTO $prefix.`_seo_dh_master` VALUES (19, 1800, 'name', 'COPYRIGHT', 'Copyright (c) 2009-2010 by $sitename', 1);
...
INSERT INTO $prefix.`_seo_dh_master` VALUES (25, 2400, 'name', 'GENERATOR', 'RavenNuke(tm) Copyright (c) 2002-2010 by Gaylen Fraley. This is free software, and you may redistribute it under the GPL (http://www.gnu.org/licenses/gpl-2.0.txt). RavenNuke(tm) is supported by the RavenNuke(tm) Team at http://www.ravenphpscripts.com .', 1);